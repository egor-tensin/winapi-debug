...
public:
    ...
    Address get_displacement() const {
        return displacement;
    }
    ...
    Address get_offline_base() const {
        return get_impl().ModBase;
    }

    Address get_offline_address() const {
        return get_impl().Address;
    }

    symbol::Tag get_tag() const {
        return get_impl().Tag;
    }
    ...
    Type get_type() const {
        return static_cast<Type>(get_tag());
    }
...
private:
    ...
    const Impl& get_impl() const {
        return *reinterpret_cast<const Impl*>(buffer.data());
    }

    Impl& get_impl() {
        return *reinterpret_cast<Impl*>(buffer.data());
    }
};
...
public:
    ...
    Address get_online_address() const {
